...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.content_type_label'
        db.add_column(u'media_video', 'content_type_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Image.content_type_label'
        db.add_column(u'media_image', 'content_type_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.content_type_label'
        db.delete_column(u'media_video', 'content_type_label')

        # Deleting field 'Image.content_type_label'
        db.delete_column(u'media_image', 'content_type_label')
    ...
    models = {
        ...
        u'media.ajaxfileuploaded': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 24, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
