...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AjaxFileUploaded.date'
        db.add_column(u'media_ajaxfileuploaded', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 28, 0, 0), auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AjaxFileUploaded.date'
        db.delete_column(u'media_ajaxfileuploaded', 'date')
    ...
    models = {
        ...
        u'media.ajaxfileuploaded': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 28, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
